...
class EncoderBlock(nn.Module):
    ...
    def __init__(self, features, self_attention, ff_block, dropout):
        super().__init__()
        self.self_attention_block = self_attention
        self.feed_forward_block = ff_block
...
class DecoderBlock(nn.Module):
    ...
    def __init__(self, features, self_attention, cross_attention, ff_block, dropout):
        super().__init__()
        self.self_attention_block = self_attention
